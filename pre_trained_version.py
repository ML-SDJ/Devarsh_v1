# # ==========================================
# # Chest X-Ray Pneumonia Classifier (Optimized)
# # ==========================================
# import os
# import torch
...
#         torch.save(model.state_dict(), "best_resnet_chestxray.pth")
#         early_stop_counter = 0
#     else:
...
# # -----------------------------
# model.load_state_dict(torch.load("best_resnet_chestxray.pth", map_location=device))
# model.eval()
#
# y_true, y_pred = [], []
# with torch.no_grad():
...
#                 "image_name": filename,
#                 "true_class": cls,
#                 "predicted_class": train_dataset.classes[pred]
#             })
#
# results_df = pd.DataFrame(results)
# results_df.to_csv("resnet_predictions.csv", index=False)
# print("Predictions saved to resnet_predictions.csv")
